...
## 2026-08-29：`0.1.56` 内网设备扫描与传输测速优化

- 增加网络工具文件夹、按需展开的内网设备扫描和设备详情聚焦视图。
- 扫描合并主动网段探测与系统邻居表，过滤组播/广播地址并保留本机 IP。
- 增加 MAC OUI 厂商线索、在线/离线历史记录和后台扫描，避免刷新卡顿。
- SFTP 速度显示刷新降至 2.5 秒，减少视觉抖动。
- 发布清单见 [v0.1.56 Release Checklist](../docs/release-v0.1.56.md)。
