# Joyshell Development Notes

This directory records Joyshell implementation notes by component. Each note should capture:

- component responsibility and boundaries
- development difficulties
- mature open-source or official references
- adopted solution
- verification steps
- follow-up risks and TODOs
